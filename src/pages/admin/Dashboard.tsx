...
const AdminDashboardPage = () => {
  ...
  const totalSarees = sareesData.length;
  const featuredSarees = sareesData.filter(saree => saree.featured).length;
  
  // Find price ranges
  const prices = sareesData.map(saree => saree.price);
        ...
        <div className="bg-white shadow rounded-lg p-6 col-span-1 lg:col-span-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <div>
                <h4 className="text-lg font-medium text-gray-900">Update Sarees</h4>
                <p className="text-gray-500 text-sm">
                  Modify existing saree listings
                </p>
              </div>
            </Link>
          </div>
